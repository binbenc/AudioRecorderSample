package com.cxb.android.recordingsample.record;

import android.content.Context;
import android.os.Environment;
import android.text.TextUtils;

import com.cxb.android.recordingsample.App;
...
/*        if (isSdcardExit()) {
        ...
        String fileBasePath = App.context.getFilesDir() + AUDIO_PCM_BASEPATH;
        File file = new File(fileBasePath);
        //创建目录
        if (!file.exists()) {
            file.mkdirs();
...
/*        if (isSdcardExit()) {
        ...
        String fileBasePath = App.context.getFilesDir() + AUDIO_WAV_BASEPATH;
        File file = new File(fileBasePath);
        //创建目录
        if (!file.exists()) {
            file.mkdirs();
